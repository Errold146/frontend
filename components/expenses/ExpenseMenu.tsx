                ...
                >
                    <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                        <MenuItem>
                            <button
                                type='button'
                                className='block px-3 py-1 font-semibold leading-6 text-purple-700 hover:text-purple-500'
                        ...
                        <MenuItem>
                            <button
                                type='button'
                                className='block px-3 py-1 font-semibold leading-6 text-red-700 hover:text-red-500'
